...
public class AdminController {
    ...
    public ResponseEntity<Void> addCountry(@RequestParam int serviceProviderId, @RequestParam String countryName) throws Exception{
        ...
        // Each character can be in uppercase or lowercase. You should create a new Country
        // object based on the given country name and add it to the country list of the service provider.
