...
public class ConnectionController {
    ...
    public ResponseEntity<Void> connect(@RequestParam int userId, @RequestParam String countryName) throws Exception{
         ...
         * 3. Else, the user should be subscribed under a serviceProvider having option to
         *  connect to the given country.
         ...
         *     else, establish the connection where the maskedIp is
         *   "updatedCountryCode.serviceProviderId.userId" and return the updated user.
